package learn.lhb.lhb_notepad_01.adapter;
...
import learn.lhb.lhb_notepad_01.R;
...
public class NotepadAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tvBotepadTime.setText(noteInfo.getNotepadTime());
        return convertView;
    }
    ...
    class ViewHolder {
        ...
        TextView tvBotepadTime;

        public ViewHolder(View view) {
            tvNoteoadContent = (TextView) view.findViewById(R.id.item_content);
            tvBotepadTime = (TextView) view.findViewById(R.id.item_time);
        }
    }
}
